...
public class TestFtp {
    ...
    public static void main(String[] args) {
        ShareParam setting = new ShareParam("ftp", "172.16.139.133", 21,
                "administrator", "Windows2000@", null, "/", new HashMap<>());

        BaseClient client = new FtpClient();
    ...
    private static void download(BaseClient client, ShareParam setting) {
        ...
        try {
            ...
            b = client.downloadFile(setting, "\\data\\ForecastData/GF0101/20210103/GF0101_20210103.SATECI", "c:/tt/666.txt");
